...
namespace SteamBot {
	...
	public class InventoryResult {
		...
		public string num_backpack_slots {
			get;
			set;
		}
	...
	public class SchemaResult {
		...
		public SchemaItem[] items {
			get;
			set;
		}

		public ItemOrigin[] originNames {
			get;
			set;
		}
	}
	...
	public class TradeLog {
		...
		public List<TradeItem> ItemsReceived {
			get;
			set;
		}
		public List<TradeItem> ItemsLost {
			get;
			set;
		}
	}
